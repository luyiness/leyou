...
public class GoodsService {
    ...
    public Map<String, Object> loadData(Long spuId){
        ...
        List<String> names = this.categoryClient.queryNamesByIds(cids);  //获取names

        List<Map<String, Object>> categories = new ArrayList<>();
        for (int i = 0; i < cids.size(); i++) {     //遍历list
            Map<String, Object> categoryMap = new HashMap<>();  //在循环中每次都new个map
